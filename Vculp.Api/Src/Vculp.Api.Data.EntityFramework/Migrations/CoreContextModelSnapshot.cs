...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vculp.Api.Domain.Core.FavoriteRegion.FavoriteRegion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ClusterId")
                        .IsUnique()
                        .HasDatabaseName("IX_FavoriteRegions_ClusterId");

                    SqlServerIndexBuilderExtensions.IsClustered(b.HasIndex("ClusterId"));

                    b.HasIndex("IsDeleted")
                        .HasDatabaseName("IX_FavoriteRegions_IsDeleted");

                    b.ToTable("FavoriteRegions", "FavoriteRegion");
                });
